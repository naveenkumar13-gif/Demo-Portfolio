...
<h1 className='w-1/2  text-8xl leading-[1.1] font-extrabold pb-4  max-md:text-6xl  max-lg:text-[3.5rem]  max-sm:text-[3rem]  max-sm:text-center max-sm:w-3/4 max-sm:pb-2'>Product Designer</h1>
